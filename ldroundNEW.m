function [nsDice,turn,totalTurns,likelyBS,nDice,bets,dice,playerWhoLost,playerWhoBSed,lies,truths,pHonestArray] = ...
    ldroundNEW(nsDice,turn,likelyBS,traits,pHonestArray,lies,truths)
...
%% loop that runs turns around the circle until "BS" is called
    [quant,numb,likelyBS,totalTurns,turn,playerOfInterest,playerOfInterest2] = runTurns(dice,nsDice,quant,numb,nDice,bets,...
   traits,pHonestArray,turn,totalTurns,likelyBS,bs);
